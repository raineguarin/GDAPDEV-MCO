...
- Payment processes and license verification

## Technology Stack
**Frontend**: HTML, CSS, Javascript

## Current Status
The frontend is currently being built and revised for navigability and user interface. 

### Prerequisite Downloads
There are no prerequisite downloads needed for this project.
